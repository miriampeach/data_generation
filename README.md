...
[![License](https://img.shields.io/github/license/miriampeach/data_generation)](https://opensource.org/license/mit/)
...
- [rockerc](https://github.com/miriampeach/rockerc): A command-line tool for dynamically creating docker containers with access to host resources such as GPU and 
- [rockervsc](https://github.com/miriampeach/rockervsc): A Visual Studio Code extension that integrates rockerc functionality into [vscode remote containers](https://marketplace.visualstudio.com/items?itemName=ms-vscode-remote.remote-containers).
